...
// ViewBox 400×240 — execution axis runs left→right at y=120
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: compact ? '1.25rem 1rem 1rem' : '1.75rem 1.25rem 1.5rem',
      }}
    >
      <svg
        viewBox="0 0 400 240"
      ...
      >
        ...
        <circle cx={IX} cy={IY} r={4.5} fill="var(--diagram-node)" opacity={0.72} />
        {/* STRATEGIC INTENT label — kept in compact since it anchors the whole diagram */}
        <text x={10} y={IY - 11} fill="var(--diagram-node)" opacity={0.38} style={mono()}>
          STRATEGIC INTENT
        </text>
        ...
        <motion.g animate={vis(0)} transition={tr}>
          <line
            ...
            stroke="var(--diagram-path)" strokeWidth={1} opacity={0.55}
          />
          <circle cx={OX} cy={OY} r={5}  fill="var(--diagram-outcome)" opacity={0.82} />
          <circle cx={OX} cy={OY} r={13} stroke="var(--diagram-outcome)" strokeWidth={0.6} opacity={0.24} />
          <text x={OX} y={OY + 24} textAnchor="middle" fill="var(--diagram-outcome)" opacity={0.50} style={mono()}>
            INTENDED OUTCOME
          </text>
        </motion.g>
        ...
        <motion.g animate={vis(1)} transition={tr}>
          <line
            ...
            stroke="var(--diagram-path)" strokeWidth={1} opacity={0.48}
          />
          <path
            d={`M ${FX},${FY} C ${FX+44},${FY} ${FX+76},${BT.y} ${BT.x},${BT.y}`}
            stroke="var(--diagram-path)" strokeWidth={0.9} opacity={0.36}
          />
          <line
          ...
          <path
            ...
            stroke="var(--diagram-path)" strokeWidth={0.9} opacity={0.36}
          />
          <circle cx={FX} cy={FY} r={3.5} fill="var(--diagram-exposure)" opacity={0.70} />
          <circle cx={BT.x} cy={BT.y} r={3} fill="var(--diagram-node)" opacity={0.42} />
          <circle cx={BM.x} cy={BM.y} r={3} fill="var(--diagram-node)" opacity={0.42} />
          <circle cx={BB.x} cy={BB.y} r={3} fill="var(--diagram-node)" opacity={0.42} />
          <circle cx={OX} cy={OY} r={11} stroke="var(--diagram-outcome)" strokeWidth={0.5} opacity={0.12} />
        ...
        <motion.g animate={vis(2)} transition={tr}>
          <line
            ...
            stroke="var(--diagram-path)" strokeWidth={1} opacity={0.56}
          />
          <line
            x1={IX} y1={OBS_Y} x2={IX} y2={IY}
            stroke="var(--diagram-path)" strokeWidth={0.6} opacity={0.22}
          />
          <line
            x1={IX} y1={IY} x2={OX} y2={OY}
            stroke="var(--diagram-path)" strokeWidth={1} strokeDasharray="6 9" opacity={0.28}
          />
          {/* Essential: distinguishes reporting from execution */}
          <text x={OX - 4} y={OBS_Y - 8} textAnchor="end" fill="var(--diagram-node)" opacity={0.44} style={mono()}>
            STATUS
          </text>
          <text x={OX - 4} y={OY + 16} textAnchor="end" fill="var(--diagram-node)" opacity={0.24} style={mono()}>
            EXECUTION
          </text>
          <circle cx={OX} cy={OY} r={9} stroke="var(--diagram-outcome)" strokeWidth={0.5} opacity={0.15} />
        </motion.g>
        ...
        <motion.g animate={vis(3)} transition={tr}>
          <line
            ...
            stroke="var(--diagram-path)" strokeWidth={1} opacity={0.52}
          />
          <line
            x1={IX} y1={OBS_Y} x2={IX} y2={IY}
            stroke="var(--diagram-path)" strokeWidth={0.6} opacity={0.22}
          />
          <line x1={156} y1={OBS_Y - 5} x2={156} y2={OBS_Y + 5} stroke="var(--diagram-path)" strokeWidth={0.5} opacity={0.18} />
          <line x1={240} y1={OBS_Y - 5} x2={240} y2={OBS_Y + 5} stroke="var(--diagram-path)" strokeWidth={0.5} opacity={0.18} />
          <line
            x1={248} y1={OBS_Y} x2={OX} y2={OBS_Y}
            stroke="var(--diagram-path)" strokeWidth={0.9} strokeDasharray="4 6" opacity={0.22}
          />
          <line
            x1={IX} y1={IY} x2={OX} y2={OY}
            stroke="var(--diagram-path)" strokeWidth={1} strokeDasharray="5 8" opacity={0.25}
          />
          {/* Essential: names the layer that structurally breaks */}
          <text x={50} y={OBS_Y - 8} fill="var(--diagram-node)" opacity={0.40} style={mono()}>
            VISIBILITY
          </text>
          <circle cx={OX} cy={OY} r={9} stroke="var(--diagram-outcome)" strokeWidth={0.5} opacity={0.12} />
        </motion.g>
        ...
        <motion.g animate={vis(4)} transition={tr}>
          <line
            ...
            stroke="var(--diagram-path)" strokeWidth={1} strokeDasharray="5 8" opacity={0.30}
          />
          <circle cx={O4O.x} cy={O4O.y} r={9}  stroke="var(--diagram-outcome)" strokeWidth={0.6} fill="none" opacity={0.18} />
          <line
            x1={O4O.x + 12} y1={O4O.y} x2={O4S.x - 8} y2={O4S.y}
            stroke="var(--diagram-path)" strokeWidth={0.7} strokeDasharray="3 5" opacity={0.28}
          />
          <circle cx={O4S.x} cy={O4S.y} r={5}  fill="var(--diagram-outcome)" opacity={0.62} />
          <circle cx={O4S.x} cy={O4S.y} r={12} stroke="var(--diagram-outcome)" strokeWidth={0.6} fill="none" opacity={0.22} />
          {/* Omitted in compact — shifted amber ring vs. hollow original is self-evident */}
          {!compact && (
            <text x={O4S.x} y={O4S.y + 24} textAnchor="middle" fill="var(--diagram-outcome)" opacity={0.40} style={mono()}>
              INTENDED OUTCOME
            </text>
          )}
        </motion.g>
        ...
        <motion.g animate={vis(5)} transition={tr}>
          <path
            ...
            stroke="var(--diagram-path)" strokeWidth={1} strokeDasharray="5 7" opacity={0.35}
          />
          <circle cx={D5.x} cy={D5.y} r={5}  fill="var(--diagram-node)" opacity={0.74} />
          <line
            x1={D5.x + 10} y1={D5.y - 8} x2={OX - 14} y2={OY + 12}
            stroke="var(--diagram-path)" strokeWidth={0.5} strokeDasharray="3 6" opacity={0.14}
          />
          <circle cx={OX} cy={OY} r={11} stroke="var(--diagram-outcome)" strokeWidth={0.7} fill="none" opacity={0.34} />
          <circle cx={OX} cy={OY} r={4}  stroke="var(--diagram-outcome)" strokeWidth={0.6} fill="none" opacity={0.22} />
          {/* Essential: without labels the two nodes don't tell apart delivered vs. intended */}
          <text x={D5.x} y={D5.y + 17} textAnchor="middle" fill="var(--diagram-node)" opacity={0.44} style={mono()}>
            DELIVERED OUTPUT
          </text>
          <text x={OX} y={OY - 22} textAnchor="middle" fill="var(--diagram-outcome)" opacity={0.40} style={mono()}>
            INTENDED OUTCOME
          </text>
        </motion.g>
      </svg>
